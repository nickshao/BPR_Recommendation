...
class BPR(nn.Module):
    def __init__(self, user_size, item_size, embedding_size, batch_size, train_u2i, device):
    ...
    def forward(self, u, i, j):
        ...
        "Maximize the difference of predictions of (x_ui - x_uj)" 
        ...
        loss = torch.log(torch.sigmoid(R_ui - R_uj)).sum()
